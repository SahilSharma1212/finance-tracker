...
const SignupPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      } else if(response.data.success===false && response.data.message==="User already exists. Please use a different username or email.") {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-black">
      <Card className="p-8 w-full max-w-md bg-[#1c1c1c] rounded-lg border border-white/30 max-sm:scale-90">
        <h2 className="text-2xl text-center font-bold text-purple-600 mb-6">Sign Up</h2>
